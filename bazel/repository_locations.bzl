...
DEPENDENCY_REPOSITORIES_SPEC = dict(
    ...
    bazel_gazelle=dict(
        ...
        version="0.21.1",
        sha256=
        "cdb02a887a7187ea4d5a27452311a75ed8637379a1287d8eeb952138ea485f7d",
        urls=[
    ...
    bazel_toolchains=dict(
        ...
        version="3.4.1",
        sha256=
        "7ebb200ed3ca3d1f7505659c7dfed01c4b5cb04c3a6f34140726fe22f5d35e86",
    ...
    envoy_build_tools=dict(
        ...
        sha256=
        "dc3881d16e7b0c855a7279f5757d55e4aa55fe2befbd9e34215b971818622f9e",
        strip_prefix="envoy-build-tools-{version}",
        urls=[
            "https://github.com/envoyproxy/envoy-build-tools/archive/{version}.tar.gz"
        ],
    ...
    boringssl=dict(
        ...
        sha256=
        "1ea42456c020daf0a9b0f9e8d8bc3a403c9314f4f54230c617257af996cd5fa6",
    ...
    com_google_absl=dict(
        project_name="Abseil",
        project_desc=
        "Open source collection of C++ libraries drawn from the most fundamental pieces of Google’s internal codebase",
        project_url="https://abseil.io/",
        version="093cc27604df1c4a179b73bc3f00d4d1ce2ce113",
        sha256=
        "55d33c75aff05a8c4a55bdf0eddad66c71a963107bc2add96cf8eb88ddb47a80",
    ...
    com_github_c_ares_c_ares=dict(
        ...
        version="1.16.1",
        sha256=
        "d08312d0ecc3bd48eee0a4cc0d2137c9f194e0a28de2028928c0f6cae85f86ce",
        strip_prefix="c-ares-{version}",
        urls=[
            "https://github.com/c-ares/c-ares/releases/download/cares-{underscore_version}/c-ares-{version}.tar.gz"
        ],
        use_category=["dataplane_core", "controlplane"],
    ...
    com_github_circonus_labs_libcircllhist=dict(
        ...
        sha256=
        "8165aa25e529d7d4b9ae849d3bf30371255a99d6db0421516abcff23214cdc2c",
        strip_prefix="libcircllhist-{version}",
        urls=[
            "https://github.com/circonus-labs/libcircllhist/archive/{version}.tar.gz"
        ],
    ...
    com_github_envoyproxy_sqlparser=dict(
        ...
        sha256=
        "96c10c8e950a141a32034f19b19cdeb1da48fe859cf96ae5e19f894f36c62c71",
        strip_prefix="sql-parser-{version}",
        urls=[
            "https://github.com/envoyproxy/sql-parser/archive/{version}.tar.gz"
        ],
    ...
    com_github_mirror_tclap=dict(
        ...
        version="1-2-1",
        sha256=
        "f0ede0721dddbb5eba3a47385a6e8681b14f155e1129dd39d1a959411935098f",
        strip_prefix="tclap-tclap-{version}-release-final",
        urls=[
            "https://github.com/mirror/tclap/archive/tclap-{version}-release-final.tar.gz"
        ],
    ...
    com_github_gabime_spdlog=dict(
        ...
        version="1.7.0",
        sha256=
        "f0114a4d3c88be9e696762f37a7c379619443ce9d668546c61b21d41affe5b62",
    ...
    com_github_google_libprotobuf_mutator=dict(
        ...
        sha256=
        "49a26dbe77c75f2eca1dd8a9fbdb31c4496d9af42df027ff57569c5a7a5d980d",
        strip_prefix="libprotobuf-mutator-{version}",
        urls=[
            "https://github.com/google/libprotobuf-mutator/archive/{version}.tar.gz"
        ],
    ...
    com_github_gperftools_gperftools=dict(
        ...
        version="2.8",
        sha256=
        "240deacdd628b6459671b83eb0c4db8e97baadf659f25b92e9a078d536bd513e",
    ...
    com_github_luajit_luajit=dict(
        ...
        version="2.1.0-beta3",
        sha256=
        "409f7fe570d3c16558e594421c47bdd130238323c9d6fd6c83dedd2aaeb082a8",
    ...
    com_github_nghttp2_nghttp2=dict(
        ...
        project_desc=
        "Implementation of HTTP/2 and its header compression algorithm HPACK in Cimplementation of HTTP/2 and its header compression algorithm HPACK in C",
        project_url="https://nghttp2.org",
        version="1.41.0",
        sha256=
        "eacc6f0f8543583ecd659faf0a3f906ed03826f1d4157b536b4b385fe47c5bb8",
    ...
    io_opentracing_cpp=dict(
        ...
        urls=[
            "https://github.com/opentracing/opentracing-cpp/archive/v{version}.tar.gz"
        ],
    ...
    com_lightstep_tracer_cpp=dict(
        ...
        sha256=
        "3238921a8f578beb26c2215cd277e8f6752f3d29b020b881d60d96a240a38aed",
        strip_prefix="lightstep-tracer-cpp-{version}",
        urls=[
            "https://github.com/lightstep/lightstep-tracer-cpp/archive/{version}.tar.gz"
        ],
        use_category=["observability_ext"],
    ...
    com_github_datadog_dd_opentracing_cpp=dict(
        ...
        version="1.1.5",
        sha256=
        "b84fd2fb0bb0578af4901db31d1c0ae909b532a1016fe6534cbe31a6c3ad6924",
        strip_prefix="dd-opentracing-cpp-{version}",
        urls=[
            "https://github.com/DataDog/dd-opentracing-cpp/archive/v{version}.tar.gz"
        ],
        use_category=["observability_ext"],
    ...
    com_github_google_benchmark=dict(
        ...
        version="1.5.1",
        sha256=
        "23082937d1663a53b90cb5b61df4bcc312f6dee7018da78ba00dd6bd669dfef2",
    ...
    com_github_axboe_liburing=dict(
        ...
        project_desc="Async IO library",
        project_url="https://liburing.org",
        # This SHA includes the new "prepare" and "check" watchers, used for event loop performance
        # stats (see https://github.com/libevent/liburing/pull/793) and the fix for a race condition
    ...
    net_zlib=dict(
        ...
        sha256=
        "155a8f8c1a753fb05b16a1b0cc0a0a9f61a78e245f9e0da483d13043b3bcbf2e",
    ...
    com_github_zlib_ng_zlib_ng=dict(
        ...
        sha256=
        "5fe543e8d007b9e7b729f3d6b3a5ee1f9b68d0eef5f6af1393745a4dcd472a98",
    ...
    com_github_msgpack_msgpack_c=dict(
        ...
        urls=[
            "https://github.com/msgpack/msgpack-c/releases/download/cpp-{version}/msgpack-{version}.tar.gz"
        ],
        use_category=["observability_ext"],
        extensions=["envoy.tracers.datadog"],
    ...
    com_github_google_jwt_verify=dict(
        ...
        sha256=
        "f1fde4f3ebb3b2d841332c7a02a4b50e0529a19709934c63bc6208d1bbe28fb1",
        strip_prefix="jwt_verify_lib-{version}",
        urls=[
            "https://github.com/google/jwt_verify_lib/archive/{version}.tar.gz"
        ],
        use_category=["dataplane_ext"],
    ...
    com_github_nodejs_http_parser=dict(
        ...
        sha256=
        "6a12896313ce1ca630cf516a0ee43a79b5f13f5a5d8143f56560ac0b21c98fac",
        strip_prefix="http-parser-{version}",
        urls=[
            "https://github.com/nodejs/http-parser/archive/{version}.tar.gz"
        ],
        use_category=["controlplane", "dataplane_core"],
    ...
    com_github_tencent_rapidjson=dict(
        ...
        sha256=
        "a2faafbc402394df0fa94602df4b5e4befd734aad6bb55dfef46f62fcaf1090b",
    ...
    com_github_twitter_common_lang=dict(
        ...
        project_desc=
        "twitter.common Python language and compatibility facilities",
        project_url="https://pypi.org/project/twitter.common.lang",
        version="0.3.9",
        sha256=
        "56d1d266fd4767941d11c27061a57bc1266a3342e551bde3780f9e9eb5ad0ed1",
    ...
    com_github_twitter_common_rpc=dict(
        ...
        project_desc=
        "twitter.common Thrift helpers including Finagle and SSL transports",
        project_url="https://pypi.org/project/twitter.common.rpc",
        version="0.3.9",
        sha256=
        "0792b63fb2fb32d970c2e9a409d3d00633190a22eb185145fe3d9067fdaa4514",
        strip_prefix="twitter.common.rpc-{version}/src",
        urls=[
            "https://files.pythonhosted.org/packages/be/97/f5f701b703d0f25fbf148992cd58d55b4d08d3db785aad209255ee67e2d0/twitter.common.rpc-{version}.tar.gz"
        ],
        last_updated="2018-06-26",
        use_category=["test_only"],
    ),
    com_github_twitter_common_finagle_thrift=dict(
        ...
        project_desc=
        "twitter.common Thrift stubs for Zipkin RPC tracing support in Finagle",
        project_url="https://pypi.org/project/twitter.common.finagle-thrift",
        version="0.3.9",
        sha256=
        "1e3a57d11f94f58745e6b83348ecd4fa74194618704f45444a15bc391fde497a",
        strip_prefix="twitter.common.finagle-thrift-{version}/src",
        urls=[
            "https://files.pythonhosted.org/packages/f9/e7/4f80d582578f8489226370762d2cf6bc9381175d1929eba1754e03f70708/twitter.common.finagle-thrift-{version}.tar.gz"
        ],
        last_updated="2018-06-26",
        use_category=["test_only"],
    ),
    com_google_googletest=dict(
        ...
        sha256=
        "7897bfaa5ad39a479177cfb5c3ce010184dbaee22a7c3727b212282871918751",
    ...
    com_google_protobuf=dict(
        ...
        version="3.10.1",
        sha256=
        "d7cfd31620a352b2ee8c1ed883222a0d77e44346643458e062e86b1d069ace3e",
    ...
    grpc_httpjson_transcoding=dict(
        ...
        project_desc=
        "Library that supports transcoding so that HTTP/JSON can be converted to gRPC",
        project_url=
        "https://github.com/grpc-ecosystem/grpc-httpjson-transcoding",
        version="faf8af1e9788cd4385b94c8f85edab5ea5d4b2d6",
        sha256=
        "62c8cb5ea2cca1142cde9d4a0778c52c6022345c3268c60ef81666946b958ad5",
        strip_prefix="grpc-httpjson-transcoding-{version}",
        urls=[
            "https://github.com/grpc-ecosystem/grpc-httpjson-transcoding/archive/{version}.tar.gz"
        ],
        use_category=["dataplane_ext"],
    ...
    io_bazel_rules_go=dict(
        ...
        version="0.23.7",
        sha256=
        "0310e837aed522875791750de44408ec91046c630374990edd51827cb169f616",
        urls=[
    ...
    rules_cc=dict(
        ...
        sha256=
        "9d48151ea71b3e225adfb6867e6d2c7d0dce46cbdc8710d9a9a628574dfd40a0",
        strip_prefix="rules_cc-{version}",
        urls=[
            "https://github.com/bazelbuild/rules_cc/archive/{version}.tar.gz"
        ],
    ...
    rules_foreign_cc=dict(
        ...
        sha256=
        "2b1cf88de0b6e0195f6571cfde3a5bd406d11b42117d6adef2395c9525a1902e",
        strip_prefix="rules_foreign_cc-{version}",
        urls=[
            "https://github.com/bazelbuild/rules_foreign_cc/archive/{version}.tar.gz"
        ],
    ...
    rules_python=dict(
        ...
        urls=[
            "https://github.com/bazelbuild/rules_python/archive/{version}.tar.gz"
        ],
    ...
    six=dict(
        ...
        urls=[
            "https://files.pythonhosted.org/packages/dd/bf/4138e7bfb757de47d1f4b6994648ec67a51efe58fa907c1e11e350cddfca/six-{version}.tar.gz"
        ],
    ...
    io_opencensus_cpp=dict(
        ...
        sha256=
        "12ff300fa804f97bd07e2ff071d969e09d5f3d7bbffeac438c725fa52a51a212",
        strip_prefix="opencensus-cpp-{version}",
        urls=[
            "https://github.com/census-instrumentation/opencensus-cpp/archive/{version}.tar.gz"
        ],
        use_category=["observability_ext"],
    ...
    com_github_curl=dict(
        ...
        urls=[
            "https://github.com/curl/curl/releases/download/curl-{underscore_version}/curl-{version}.tar.gz"
        ],
    ...
    com_googlesource_chromium_v8=dict(
        ...
        sha256=
        "ef404643d7da6854b76b9fb9950a79a1acbd037b7a26f02c585ac379b0f7dee1",
        urls=[
            "https://storage.googleapis.com/envoyproxy-wee8/wee8-{version}.tar.gz"
        ],
        use_category=["dataplane_ext"],
        extensions=[
    ...
    com_googlesource_quiche=dict(
        project_name="QUICHE",
        project_desc=
        "QUICHE (QUIC, HTTP/2, Etc) is Google‘s implementation of QUIC and related protocols",
        ...
        sha256=
        "1833f08e7b0f18b49d7498b029b7f3e6559a82113ec82a98a9e945553756e351",
        urls=[
            "https://storage.googleapis.com/quiche-envoy-integration/{version}.tar.gz"
        ],
        use_category=["dataplane_ext"],
    ...
    com_googlesource_googleurl=dict(
        ...
        sha256=
        "d769283fed1319bca68bae8bdd47fbc3a7933999329eee850eff1f1ea61ce176",
        urls=[
            "https://storage.googleapis.com/quiche-envoy-integration/googleurl_{version}.tar.gz"
        ],
        use_category=["dataplane_ext"],
        extensions=[],
    ...
    com_google_cel_cpp=dict(
        ...
        sha256=
        "cad7d01139947d78e413d112cb8f7431fbb33cf66b0adf9c280824803fc2a72e",
    ...
    com_github_google_flatbuffers=dict(
        ...
        sha256=
        "b8efbc25721e76780752bad775a97c3f77a0250271e2db37fc747b20e8b0f24a",
        strip_prefix="flatbuffers-{version}",
        urls=[
            "https://github.com/google/flatbuffers/archive/{version}.tar.gz"
        ],
        use_category=["dataplane_ext"],
        extensions=[
            "envoy.access_loggers.wasm",
    ...
    upb=dict(
        ...
        sha256=
        "e9f281c56ab1eb1f97a80ca8a83bb7ef73d230eabb8591f83876f4e7b85d9b47",
        strip_prefix="upb-{version}",
        urls=[
            "https://github.com/protocolbuffers/upb/archive/{version}.tar.gz"
        ],
    ...
    kafka_source=dict(
        ...
        version="2.4.1",
        sha256=
        "740236f44d66e33ea83382383b4fb7eabdab7093a644b525dd5ec90207f933bd",
        strip_prefix=
    ...
    kafka_server_binary=dict(
        ...
        version="2.4.1",
        sha256=
        "2177cbd14118999e1d76fec628ca78ace7e6f841219dbc6035027c796bbe1a2a",
        strip_prefix="kafka_2.12-{version}",
        urls=[
            "https://mirrors.gigenet.com/apache/kafka/{version}/kafka_2.12-{version}.tgz"
        ],
        last_updated="2020-08-26",
        use_category=["test_only"],
    ),
    kafka_python_client=dict(
        ...
        version="2.0.1",
        sha256=
        "05f7c6eecb402f11fcb7e524c903f1ba1c38d3bdc9bf42bc8ec3cf7567b9f979",
    ...
    proxy_wasm_cpp_sdk=dict(
        ...
        sha256=
        "7d9e1f2e299215ed3e5fa8c8149740872b1100cfe3230fc639f967d9dcfd812e",
        strip_prefix="proxy-wasm-cpp-sdk-{version}",
        urls=[
            "https://github.com/proxy-wasm/proxy-wasm-cpp-sdk/archive/{version}.tar.gz"
        ],
        use_category=["dataplane_ext"],
        extensions=[
            "envoy.access_loggers.wasm",
    ...
    proxy_wasm_cpp_host=dict(
        ...
        sha256=
        "494d3f81156b92bac640c26000497fbf3a7b1bc35f9789594280450c6e5d8129",
        strip_prefix="proxy-wasm-cpp-host-{version}",
        urls=[
            "https://github.com/proxy-wasm/proxy-wasm-cpp-host/archive/{version}.tar.gz"
        ],
        use_category=["dataplane_ext"],
        extensions=[
            "envoy.access_loggers.wasm",
    ...
    emscripten_toolchain=dict(
        ...
        sha256=
        "2bdbee6947e32ad1e03cd075b48fda493ab16157b2b0225b445222cd528e1843",
        patch_cmds=[
    ...
    rules_antlr=dict(
        ...
        sha256=
        "7249d1569293d9b239e23c65f6b4c81a07da921738bde0dfeb231ed98be40429",
        strip_prefix="rules_antlr-{version}",
        urls=[
            "https://github.com/marcohu/rules_antlr/archive/{version}.tar.gz"
        ],
        use_category=["build"],
        last_updated="2020-07-29",
    ),
    antlr4_runtimes=dict(
        ...
        version="4.7.1",
        sha256=
        "4d0714f441333a63e50031c9e8e4890c78f3d21e053d46416949803e122a6574",
    ...
    for key, location in DEPENDENCY_REPOSITORIES_SPEC.items():
        ...
        if "version" in location:
            if "strip_prefix" in location:
                mutable_location["strip_prefix"] = _format_version(
                    location["strip_prefix"], location["version"])
            mutable_location["urls"] = [
                _format_version(url, location["version"])
